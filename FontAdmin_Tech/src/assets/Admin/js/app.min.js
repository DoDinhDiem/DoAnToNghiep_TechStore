            ...
            this._reset(),
                i(document).on('click', '.button-menu-mobile', function (t) {
                    t.preventDefault(),
                        ...
                        576 <= e.window.width() &&
                            ('condensed' === e.body.attr('data-leftbar-compact-mode') ? e.deactivateCondensedSidebar() : e.activateCondensedSidebar())
                }),
                i('.side-nav').length &&
                    ...
                    i('.side-nav a').each(function () {
                        ...
                        this.href == o &&
                            ...
                            'wrapper' !== (e = i(this).parent().parent().parent().parent().parent().parent().parent().parent().parent()).attr('id') &&
                                e.addClass('show'),
                            (a = i(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is('body') ||
            ...
            (t.prototype.initSearch = function () {
                ...
                a(document).on('click', function (t) {
                    ...
                    a('#top-search').on('focus', function (t) {
                        return (
                            t.preventDefault(), e.children('.dropdown-menu.show').removeClass('show'), a('#search-dropdown').addClass('d-block'), !1
                        )
                    }),
            ...
            (t.prototype.activateDarkMode = function () {
                ...
                this.body.css('visibility', 'hidden'),
                    ...
                    'detached' === !this.body.attr('data-layout')
                        ? (a.LeftSidebar.activateDarkTheme(), this._saveConfig({ isDarkModeEnabled: !0, sideBarTheme: i }))
            ...
            (t.prototype.initSyntaxHighlight = function () {
                a(document).ready(function (t) {
                    document.querySelectorAll('pre span.escape').forEach(function (t, e) {
                        for (
                            var a = 1 / 0, o = (t.classList.contains('escape'), t.innerText).replace(/^\n/, '').trimRight().split('\n'), i = 0;
                            i < o.length;
                            i++
                        )
